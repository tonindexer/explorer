    ...
    <div class="uk-flex uk-flex-column">
      ...
      <template v-else>
        ...
        <div v-for="block of store.getLatestBlocks" :key="block.seq_no">
          ...
          <div class="uk-flex">
            <div v-if="!isMobile()" class="uk-width-1-3 uk-text-center uk-text-primary" style="font-size: 1.1rem;">
            ...
            <div :class="isMobile()? 'uk-width-2-3' : 'uk-width-1-3 uk-text-center'" style="align-self: center; font-size: 1.1rem;">
              <NuxtLink :to="{ path: 'blocks', query: { workchain: block.workchain, shard: block.shard.toString(), seq_no: block.seq_no }, hash: '#overview'}" :class="isMobile() && 'uk-text-primary'">
