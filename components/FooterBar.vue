<template>
    <footer class="uk-background-muted footer">
        <div class="uk-flex uk-width-3-4 uk-margin-auto uk-height-1-1" style="justify-content: space-between;">
            ...
            <div class="uk-flex icons" style="align-items: center;">
                ...
                <NuxtLink :to="'https://anton.tools/api/v0/swagger'" uk-icon="icon: code"> </NuxtLink>
                <NuxtLink :to="'https://github.com/tonindexer'" uk-icon="icon: github"> </NuxtLink>
                ...
                <NuxtLink :to="'mailto:datboi@anton.tools'" uk-icon="icon: mail"></NuxtLink>
            </div>
        </div>
    </footer>
</template>
