            ...
            <template v-for="section of parseData">
                <tr v-if="!(section.object && typeof section.value === 'object')">
                    ...
                    <td class="uk-flex uk-width-1-1 uk-flex-middle" style="max-width: calc(100vw * 0.75 * 0.75)">
                        ...
                        <NuxtLink v-else-if="section.addr" class="uk-text-primary uk-text-truncate" :to="`/accounts?hex=${section.value}`" style="max-width: calc(100vw * 0.75 * 0.6)"> 
                            {{ section.value }}
                        </NuxtLink>
                    </td>
                </tr>
                <template v-else v-for="second of section.value">
                    <tr>
                        ...
                        <td class="uk-flex uk-flex-middle">
                            ...
                            <NuxtLink v-else-if="second.addr" class="uk-text-primary uk-text-truncate" :to="`/accounts?hex=${second.value}`" style="max-width: calc(100vw * 0.75 * 0.6)"> 
                                {{ second.value }}
                            </NuxtLink>
                        </td>
                    </tr>
