...
<template>
    ...
    <template v-else>
        <td :class="third !== undefined? (fourth !== undefined? 'uk-width-1-4' : 'uk-width-1-3') : 'uk-width-1-5'">
            <slot name="name"/>
        </td>
        ...
        <td class="uk-flex" :class="{'uk-text-bold' : bold, 'uk-flex-wrap' : wrap, 'uk-width-1-1' : !third}">
            <slot name="value"/>
        </td>
    </template>
</template>