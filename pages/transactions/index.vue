...
<template>
    ...
    <template v-else>
        <div v-if="isGeneral">
            ...
            <LazyTransactionsTable :keys="store.exploredTransactions" :update="true" :default-length="20" :item-selector="true" :hidden="false" :exclude-m-c="excludeMC" :order="'DESC'" :account="null"/>
        </div>
