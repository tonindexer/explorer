...
<template>
  <div
    ...
    :style="`max-width: ${isMobile() ? 'calc(' + (customMobileWidth ? customMobileWidth : '85vw') + ' - 20px)' : 'calc(' + (customDeskWidth ? customDeskWidth : '75vw * 0.8') + ' - 20px)'}`"
  >
    <slot />
  </div>
  <div
