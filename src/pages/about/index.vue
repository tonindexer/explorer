<template>
    <AtomsTile :top="true" :body="true" :tile-style="'margin-top: 20px'" :body-style="'padding: 0 16px 16px 16px'">
        <template #top>
            <h1 class="uk-margin-remove-vertical uk-text-primary">Anton</h1>
        </template>
        <template #body>
            <p class="uk-text-muted uk-margin-remove-bottom">Written in Go, Anton is an open source <a class="uk-text-primary" href="https://ton.org">The Open Network</a> blockchain indexer available under the <a class="uk-text-primary" href="https://github.com/tonindexer/anton/blob/master/LICENSE">Apache Licence 2.0</a>.
    ...
    <AtomsTile :top="true" :body="true" :tile-style="'margin-top: 20px'" :body-style="'padding: 0 16px 16px 16px'">
        ...
        <template #body>
            ...
            <p class="uk-text-muted">If you want to hack it, go to <a class="uk-text-primary" href="https://github.com/tonindexer/anton">GitHub</a>.</p>
            <p class="uk-text-muted">If you want to use it, go to <a class="uk-text-primary" href="https://anton.tools/api/v0/swagger">Swagger API documentation</a> and <a class="uk-text-primary" href="https://github.com/tonindexer/anton/blob/main/docs/API.md">API query examples</a>.</p>
            <p class="uk-text-muted uk-margin-remove-bottom">If you want to look at the data, go to <a class="uk-text-primary" href="https://superset.anton.tools">Apache Superset</a>.</p>
        </template>
    </AtomsTile>
    ...
    <AtomsTile :top="true" :body="true" :tile-style="'margin-top: 20px'" :body-style="'padding: 0 16px 16px 16px'">
        ...
        <template #body>
            <p class="uk-text-muted">Before you start, take a look at the <a class="uk-text-primary" href="https://ton.org/docs/learn/overviews/ton-blockchain">official docs</a>.</p>
            ...
            Format of every schema is described in detail in <a class="uk-text-primary" href="https://github.com/tonindexer/anton/blob/main/abi/README.md">abi/README.md</a>.
            ...
            <p class="uk-text-muted uk-margin-remove-bottom">To explore contract interfaces known to this project, visit the <a class="uk-text-primary" href="https://github.com/tonindexer/anton/tree/main/abi/known">abi/known</a> directory.
