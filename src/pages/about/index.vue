<template>
  ...
  >
    ...
    <template #body>
      <p class="uk-text-muted uk-margin-remove-bottom">
        Written in Go, Anton is an open source <a
          class="uk-text-primary"
          href="https://ton.org"
        >The Open Network</a> blockchain indexer available under the <a
          class="uk-text-primary"
          href="https://github.com/tonindexer/anton/blob/master/LICENSE"
  ...
  >
    ...
    <template #body>
      ...
      <p class="uk-text-muted">
        If you want to hack it, go to <a
          class="uk-text-primary"
          href="https://github.com/tonindexer/anton"
        >GitHub</a>.
      </p>
      <p class="uk-text-muted">
        If you want to use it, go to <a
          class="uk-text-primary"
          href="https://anton.tools/api/v0/swagger"
        >Swagger API documentation</a> and <a
          class="uk-text-primary"
          href="https://github.com/tonindexer/anton/blob/main/docs/API.md"
        >API query examples</a>.
      </p>
      <p class="uk-text-muted uk-margin-remove-bottom">
        If you want to look at the data, go to <a
          class="uk-text-primary"
          href="https://superset.anton.tools"
        >Apache Superset</a>.
      </p>
    </template>
  </AtomsTile>
  ...
  >
    ...
    <template #body>
      <p class="uk-text-muted">
        Before you start, take a look at the <a
          class="uk-text-primary"
          href="https://ton.org/docs/learn/overviews/ton-blockchain"
        >official docs</a>.
      </p>
      <p class="uk-text-muted">
        ...
        The contract data can be complex, but developers typically provide <a
          class="uk-text-primary"
          href="https://ton.org/docs/develop/func/functions#specifiers"
        >get-methods</a> in the contract, which can be executed to retrieve the necessary data.
        ...
        Contract standards also specify <a
          class="uk-text-primary"
          href="https://ton.org/docs/learn/overviews/tl-b-language#constructors"
        >TL-B constructor tags</a> (or operation ids) for each acceptable message to contract, defined as the first 32 bits of the parsed message payload cell.
      ...
      <p class="uk-text-muted">
        ...
        Format of every schema is described in detail in <a
          class="uk-text-primary"
          href="https://github.com/tonindexer/anton/blob/main/abi/README.md"
        >abi/README.md</a>.
      ...
      <p class="uk-text-muted uk-margin-remove-bottom">
        To explore contract interfaces known to this project, visit the <a
          class="uk-text-primary"
          href="https://github.com/tonindexer/anton/tree/main/abi/known"
        >abi/known</a> directory.
